function variable_init() {
	...
	#macro LAST_LEVEL Level118
	#macro GRID_SIZE 64
	#macro DEFAULT_SCORE 999
	#macro LEVEL_COUNT 119 // must be number of levels implemented + 1
	#macro SAVE_FILE "highscores.json"
	#macro VERSION "0.3.118"
	...
	global.par_scores = [0, 5, 2, 7, 8, 6, 8, 7, 7, 12, 21, 9, 14, 8, 9, 17, 21, 6, 13, 30, 9, 
						10, 10, 11, 9, 10, 14, 12, 12, 10, 26, 12, 17, 21, 27, 22, 27, 9, 16, 17, 17, 
						...
						4, 3, 4, 13, 11, 28, 23, 33, 35, 29, 3, 7, 4, 12, 7, 26, 12, 25];

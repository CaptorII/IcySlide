function variable_init() {
	...
	#macro LAST_LEVEL Level019
	#macro GRID_SIZE 64
	#macro LEVEL_COUNT 20 // must be number of levels implemented + 1
	...
	global.par_scores = [0, 5, 7, 2, 8, 7, 9, 12, 14, 17, 21, 7, 11, 9, 6, 21, 30, 13, 18, 10];
}
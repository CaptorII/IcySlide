function variable_init() {
	...
	#macro LAST_LEVEL Level058
	#macro GRID_SIZE 64
	#macro LEVEL_COUNT 59 // must be number of levels implemented + 1
	...
	global.par_scores = [0, 5, 2, 7, 8, 6, 8, 7, 7, 12, 21, 9, 14, 9, 9, 17, 21, 6, 13, 30, 9, 
						10, 10, 11, 9, 10, 15, 12, 12, 10, 26, 14, 21, 24, 27, 22, 27, 11, 16, 20, 17, 
						4, 6, 6, 8, 9, 6, 9, 8, 25, 8, 11, 19, 22, 13, 10, 31, 22, 17];

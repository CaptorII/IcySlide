function variable_init() {
	...
	#macro LAST_LEVEL Level035
	#macro GRID_SIZE 64
	#macro LEVEL_COUNT 36 // must be number of levels implemented + 1
	...
	global.par_scores = [0, 5, 2, 7, 8, 6, 8, 7, 7, 12, 21, 9, 14, 9, 11, 17, 21, 6, 13, 30, 9, 10, 10, 11, 23, 27, 11, 16, 12, 10, 26, 10, 17, 24, 20, 27];
}